...
namespace :production do
  desc "Fail unless AIRE production configuration and live durable dependencies are ready"
  task readiness: :environment do
    ...
    puts "AIRE production configuration and live dependency probes passed. Complete the manual recovery and operator evidence before payroll cutover."
  end
end
