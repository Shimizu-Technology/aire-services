...
RSpec.describe "production:readiness" do
  ...
  it "prints safe machine-readable evidence and succeeds when every check passes" do
    report = ProductionReadiness::Report.new(
      ...
      generated_at: Time.zone.parse("2026-09-14 04:00:00"),
      revision: "abc123"
    )
    ...
    expect { task.invoke }.to output(
      a_string_including(
        ...
        'EVIDENCE {"generated_at":"2026-09-14T04:00:00Z","revision":"abc123","passed":true',
        "AIRE production configuration and live dependency probes passed"
      )
    ).to_stdout
  end
