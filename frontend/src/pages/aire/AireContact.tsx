    ...
    <div className="bg-white py-14 md:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-900 md:text-5xl">Talk with AIRE about training, discovery flights, or rentals</h1>
          <p className="mt-4 text-sm leading-relaxed text-slate-600 md:text-base">
            If you’re ready to start learning, want to ask about discovery flights, or need more information about AIRE’s programs,
            reach out directly and the team can help guide you to the right next step.
          </p>
        </div>
          ...
          <section className="rounded-3xl border border-slate-200 bg-slate-50/70 p-7">
            ...
            <div className="mt-8 rounded-3xl bg-slate-950 p-6 text-white">
              ...
              <p className="mt-3 text-sm leading-relaxed text-slate-300">
                Discovery flights are one of the easiest ways to experience flying, meet the team, and decide whether full training is the right next step.
              </p>
